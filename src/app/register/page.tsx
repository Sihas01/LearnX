                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-center">
                            <button
                                ...
                                className="flex w-full items-center justify-center gap-3 rounded-2xl border border-gray-200 bg-white py-4 text-lg font-semibold text-gray-700 transition-all hover:bg-gray-50 active:scale-[0.98] shadow-sm cursor-pointer"
                            >
